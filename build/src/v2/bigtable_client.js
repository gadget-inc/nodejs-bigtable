...
class BigtableClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            ...
            sampleRowKeys: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
            mutateRows: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
            generateInitialChangeStreamPartitions: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
            readChangeStream: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
            executeQuery: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
        };
    ...
    mutateRow(request, optionsOrCallback, callback) {
        ...
        const routingParameter = {};
        {
            ...
            if (fieldValue !== undefined && fieldValue !== null) {
                const match = fieldValue
                    .toString()
                    .match(RegExp('(?<table_name>projects/[^/]+/instances/[^/]+/tables/[^/]+)'));
                if (match) {
                    const parameterValue = (_b = (_a = match.groups) === null || _a === void 0 ? void 0 : _a['table_name']) !== null && _b !== void 0 ? _b : fieldValue;
        ...
        }
        {
            ...
            if (fieldValue !== undefined && fieldValue !== null) {
                ...
                if (match) {
                    const parameterValue = (_d = (_c = match.groups) === null || _c === void 0 ? void 0 : _c['app_profile_id']) !== null && _d !== void 0 ? _d : fieldValue;
        ...
        }
        {
            ...
            if (fieldValue !== undefined && fieldValue !== null) {
                const match = fieldValue
                    .toString()
                    .match(RegExp('(?<authorized_view_name>projects/[^/]+/instances/[^/]+/tables/[^/]+/authorizedViews/[^/]+)'));
                if (match) {
                    const parameterValue = (_f = (_e = match.groups) === null || _e === void 0 ? void 0 : _e['authorized_view_name']) !== null && _f !== void 0 ? _f : fieldValue;
    ...
    pingAndWarm(request, optionsOrCallback, callback) {
        ...
        const routingParameter = {};
        {
            ...
            if (fieldValue !== undefined && fieldValue !== null) {
                ...
                if (match) {
                    const parameterValue = (_b = (_a = match.groups) === null || _a === void 0 ? void 0 : _a['name']) !== null && _b !== void 0 ? _b : fieldValue;
    ...
    generateInitialChangeStreamPartitions(request, options) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                table_name: (_a = request.tableName) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
