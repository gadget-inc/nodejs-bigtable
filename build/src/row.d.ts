...
export type MutateRowCallback = (err: ServiceError | PartialFailureError | null, apiResponse?: google.bigtable.v2.IMutateRowResponse) => void;
...
export declare class Row {
    ...
    mutate(mutation: MutationInput | MutationInput[], config: MutateRowOptions, callback: MutateRowCallback): void;
